...
{
	w->sprite[0] = "./assets/bat1.xpm";
	w->sprite[1] = "./assets/bat2.xpm";
	w->sprite[2] = "./assets/bat3.xpm";
	w->sprite[3] = "./assets/bat4.xpm";
	w->sprite[4] = "./assets/bat5.xpm";
	w->sprite[5] = "./assets/bat6.xpm";
	w->sprite[6] = "./assets/bat7.xpm";
	w->sprite[7] = "./assets/bat8.xpm";
}
